...
def main():
    ...
    ts_data = load_timeseries(conn=conn, graphInfoDF=graph, start_time='2024-07-25T17:55:00', end_time='2024-07-25T18:00:00', brick_list=sensor_list)

    list = analyze_data(graph=graph, timeseries_data=ts_data, rule=co2_rule, start_time='2024-07-25T17:55:00')
