...
graph = load_graph(devices='kaiterra_8493663d-21bf-4fa7-ba8a-163308655319.ttl')
data_dict = {
...
anomalies_list = analyze_data(start_time = '2024-07-10T09:00:00', timeseries_data=df, rule=rules_list[0])
