...
timeseriesid_co2_1 = ['8493663d-21bf-4fa7-ba8a-163308655319-co2', '9cdcab62-892c-46c8-b3d2-3d525512576a-co2', '5e81563a-42ca-4137-9b36-f423a6f27a73-co2', 'e4848531-911e-41f3-8b7a-4895a871e49b-co2']
timeseriesid_pm10 = ['8493663d-21bf-4fa7-ba8a-163308655319-pm10', '9cdcab62-892c-46c8-b3d2-3d525512576a-pm10', '5e81563a-42ca-4137-9b36-f423a6f27a73-pm10', 'e4848531-911e-41f3-8b7a-4895a871e49b-pm10']
timeseriesid_pm25 = ['8493663d-21bf-4fa7-ba8a-163308655319-pm25', '9cdcab62-892c-46c8-b3d2-3d525512576a-pm25', '5e81563a-42ca-4137-9b36-f423a6f27a73-pm25', 'e4848531-911e-41f3-8b7a-4895a871e49b-pm25']
...
def create_24h_data():
  start_time = datetime.datetime(2024, 7, 20, 0, 0, 0)
  end_time = datetime.datetime(2024, 7, 20, 23, 59, 59)
  point_reading_list = []
  while start_time < end_time:
    ...
    point_reading_list.append(PointReading(ts=start_time.isoformat(timespec='seconds'), value=random.randint(1000, 2000), timeseriesid='8493663d-21bf-4fa7-ba8a-163308655319-co2'))
